 ...
 * @author admin
 * @version 1.0.0
 * @ClassName Test0718.java
 * @Description TODO
 * @createTime 2023年07月18日 21:05:00
 */
public class Test0718 {
    ...
    public static void main(String[] args) {
        Test0718 test0718 = new Test0718();
        int [][] intervals = {{1,4}, {2,4}, {3,6}, {4,4}};
        int []queries = {2, 3, 4, 5};
        System.out.println(Arrays.toString(test0718.minInterval(intervals, queries)));
    }
