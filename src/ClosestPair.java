...
public class ClosestPair {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("closestPair:(%.2f, %.2f) and (%.2f, %.2f) \n", closestPair.p1.x, closestPair.p1.y, closestPair.p2.x,closestPair.p2.y);
        System.out.printf("closestDis: "+ closestPair.distance);
...
//
//        // 最近点对分治算法
//        double closestPairDist = closest(points);
//
//        // 输出最近点对
//        System.out.println("closestPairDIst:" + closestPairDist);
//        for (int i = 0; i < n; i++) {
//            for (int j = i + 1; j < n; j++) {
//                double dist = dist(points[i], points[j]);
//                if (Math.abs(dist - closestPairDist) < 1e-6) {
//                    System.out.printf("closestPair:(%.2f, %.2f) and (%.2f, %.2f)\n",
//                            points[i].x, points[i].y, points[j].x, points[j].y);
//                }
//            }
//        }
//        double closestPairDistbF = bruteForce(points,0,500);
//        System.out.println("bf: "+ closestPairDistbF);
//    }
//}
//
//
